 ...
 */
const instruments = List([PianoInstrument, XylophoneInstrument, EdLute, TromboneInstrument  ]);       // similar to Instrument[]

/**
 * Start with the default waveform visualizer.
 * Add your visualizers to this list.
 */
const visualizers = List([WaveformVisualizer, KenpasoVisualizer, EdmundJohnCruz, ColorsVisualizer]);    // similar to Visualizer[]
